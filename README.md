# DecodeLabs Cybersecurity Internship Projects 🛡️💻

Welcome to my repository for the **DecodeLabs Cybersecurity Internship**. This repository contains all 4 internship tasks/projects structured in organized modular directories.
...
```bash
# Run Project 1: Password Strength Checker
cd project-1-password-checker
python password_strength_checker.py

# Run Project 2: Basic Encryption & Decryption
cd ../project-2-basic-encryption
python basic_encryption.py

# Run Project 3: Phishing Awareness Analysis
cd ../project-3-phishing-awareness
python phishing_awareness_analyzer.py

# Run Project 4: System Vulnerability Checklist
...
## 👤 Author
- Internship Program: **DecodeLabs Cybersecurity Internship**
